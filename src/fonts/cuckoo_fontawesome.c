 ...
 * Size: 28 px
 * Bpp: 4
 * Opts: --bpp 4 --size 28 --no-compress --stride 1 --align 1 --font fa-solid-900.ttf --range 61617 --format lvgl -o cuckoo_fontawesome.c
 ******************************************************************************/
...
{
    {
        .range_start = 61617, .range_length = 1, .glyph_id_start = 1,
